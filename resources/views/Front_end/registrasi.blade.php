...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('Back_End/assets/vendor/css/core.css') }}"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('Back_End/assets/vendor/css/theme-default.css') }}"
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('Back_End/assets/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Bergabunglah dengan Sistem Pakar ISPA! 👋</h4>
                        <p class="mb-4">Daftar sekarang untuk memulai analisis kesehatan dan temukan solusi yang tepat
                            untuk kondisi Anda. Pastikan Anda mendapatkan informasi terbaik untuk kesehatan Anda!</p>
